...
/**
 * Copied by Apache log4j 1.2.17 and made non-final for further usage. 
 * 
 * An appender that writes to files and can roll over at intervals.
 */
@Plugin(name = NonFinalRollingFileAppender.PLUGIN_NAME, category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public class NonFinalRollingFileAppender extends AbstractOutputStreamAppender<RollingFileManager> {

    public static final String PLUGIN_NAME = "NonFinalRollingFileAppender";
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
            implements org.apache.logging.log4j.core.util.Builder<NonFinalRollingFileAppender> {
        ...
        @Override
        public NonFinalRollingFileAppender build() {
            ...
            return new NonFinalRollingFileAppender(getName(), layout, getFilter(), manager, fileName, filePattern,
    ...
    public NonFinalRollingFileAppender(final String name, final Layout<? extends Serializable> layout, final Filter filter,
     ...
     */
    @Deprecated
    public static <B extends Builder<B>> NonFinalRollingFileAppender createAppender(
            // @formatter:off
        ...
        // @formatter:off
        return NonFinalRollingFileAppender.<B>newBuilder()
